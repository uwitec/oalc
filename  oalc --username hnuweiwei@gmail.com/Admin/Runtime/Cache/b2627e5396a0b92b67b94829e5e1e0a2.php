    ...
    <div class="searchBar" style="height:auto;margin:4px auto; width:947px; border:0px solid red; ">
        <div style="width:360px; float:left; border:0px solid black;">
            <div align="center">
                 ...
                 <?php if($hasAttendence == 0): ?><a href="__URL__/add" target="dialog" mask="true"> <IMG src="__PUBLIC__/Images/daka.gif" height="77"/></a><?php endif; ?>

                 <?php if($status == 1): ?><div style="color:green; font-size:16px;margin-top:20px; ">今天你准时上班了！</div><?php endif; ?>
                  <?php if($status == 0): ?><div style="color:red; font-size:19px; margin-top:20px; ">今天你迟到了！</div><?php endif; ?>
            </div>
        </div>
